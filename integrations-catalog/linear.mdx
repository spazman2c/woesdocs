...
**Available now.** Workspaces can connect Linear, create Linear issues from Woes
support issues, open or unlink existing Linear links, use Linear in
automations, and keep linked issue status aligned between Woes and Linear.
