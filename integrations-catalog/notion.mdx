...
sidebarTitle: "Notion"
description: "Connect Notion and import selected product notes, FAQs, setup guides, and support playbooks into Woes context."
---
...
**Available now.** Workspace admins can connect Notion from **Workspace
Settings -> Integrations -> Notion**, choose shared pages, and import them as
Woes context sources.
...
Woes imports the readable content from the Notion pages you select during
import.
...
<Steps>
  ...
  <Step title="Select pages to import">
    Return to Woes, open the Notion integration, and choose the pages you want
    to import.
  </Step>
  <Step title="Import into Context">
    Click **Import selected pages**. Woes adds the pages to the Context Library
    as Notion-backed sources.
  </Step>
...
| --- | --- |
| Workspace Settings -> Integrations | Connect, reconnect, disconnect, and import selected Notion pages. |
...
- Re-import or rescan pages after important product, pricing, or setup changes.
