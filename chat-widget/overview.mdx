...
The Woes chat widget brings grounded developer support into your product,
documentation, or customer portal. It can route visitors to a workspace default
agent or to a specific agent using an agent widget key.
...
- Use agent widget keys when each product, docs area, or customer segment needs
  different context.
...
receive AI or human replies, see delivery states, and answer surveys when
configured. Operators see the same conversation in Inbox with channel, customer,
agent, and issue context.
