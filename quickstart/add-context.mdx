...
| A private docs repository | GitHub repository | Choose the branch and docs folders that match production behavior. |
...
- The source status is **Ready** or the partial warnings are understood.
